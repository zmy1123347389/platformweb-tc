...
//		//android推送
//		Demo android = new Demo(Constant.ANDROID_PUSH_APP_KEY, Constant.ANDROID_PUSH_Master_SECRET);
//		Demo ios = new Demo(Constant.IOS_PUSH_APP_KEY, Constant.IOS_PUSH_Master_SECRET);
//		//ios推送
//		try {
//			android.sendAndroidBroadcast("1", "11");
//			//android推送
//         //   android.sendAndroidCustomizedcast("101","IM","测试","这是测试消息");
//	//		 demo.sendAndroidBroadcast("test","test");
//     //       ios.sendIOSCustomizedcast("101","IM","测试","这是测试消息");
//			//ios推送
////			demo.sendIOSUnicast();
