...
public class Constant {
	...
	public static final String UPDATE_SERVICED_PRICE_FAIL = "修改服务价格失败";

	public static final String GET_DATA_FAIL = "获取数据失败";

	public static final String BALANCE_NOT_ENOUGH = "余额不足";

	public static final String DEFAULT_SIGNATURE = "快来和我视频吧！";
	...
	public static final int LOGOUT_ONLINE = -1;
	public static final int LOGOUT_DONT_DISTURB = -2;
	...
	public static final String AUTH_TITLE = "颜语认证通知";
	public static final String AUTH_SUCCESS = "恭喜您，您提交的认证信息已通过审核";
	public static final String AUTH_FAIL = "很遗憾，您提交的认证信息未通过审核，期待您再次提交审核资料";

	public static final String ALIAS = "IM";

	public static final String ONEC_TIME = "一次";
	public static final String YEAR_TIME = "每年";
	public static final String MONTH_TIME = "每月";
	public static final String DAY_TIME = "每日";
}