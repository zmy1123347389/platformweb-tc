...
public class AuthorizationUtils {
	...
	private static String getMac2() {
		/*
		 * Sigar sigar = new Sigar(); String[] ifaces = sigar.getNetInterfaceList(); for
		 * (String iface : ifaces) { NetInterfaceConfig cfg =
		 * sigar.getNetInterfaceConfig(iface); if
		 * (NetFlags.LOOPBACK_ADDRESS.equals(cfg.getAddress()) || (cfg.getFlags() &
		 * NetFlags.IFF_LOOPBACK) != 0 || NetFlags.NULL_HWADDR.equals(cfg.getHwaddr()))
		 * { continue; } String mac = cfg.getHwaddr(); return mac; }
		 */
		return null;
