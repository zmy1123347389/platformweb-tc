...
public class LawAppPoliceInfo implements Serializable {
    private static final long serialVersionUID = 7695062990468864000L;
    private String primaryId;   //用户id
    ...
    private String xp; //用户相片

    private Integer newExaminNum; //答题次数
